...
function [Tz,Cz,Sz,Pz,Chlz,PPz,DOPz,DOCz,DICz,O2z] = ...
    convection_v12_1a(Tz_in,Cz_in,Sz_in,Pz_in,Chlz_in,PPz_in,DOPz_in,DOCz_in,DICz_in,O2z_in,Tprof_prev,Vz,Cw,f_par,lambdaz_wtot_avg,zz,swa_b0,tracer_switch,springautumn);
...
%       DOCz  : Particulate inorganic carbon profile
%       DICz  : Dissolved inorganic carbon profile
%       O2z  : Dissolved inorganic oxygen profile
